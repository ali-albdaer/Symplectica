...
export function registerVisualPresetFeatures(): void {
    VisualPresetRegistry.registerFeature('starRenderer', {
        Low: { maxTextureSize: 256, granulationEnabled: false, flareQuality: 'Low' },
        High: { maxTextureSize: 1024, granulationEnabled: true, flareQuality: 'High' },
        Ultra: { maxTextureSize: 4096, granulationEnabled: true, flareQuality: 'Ultra' },
    });
