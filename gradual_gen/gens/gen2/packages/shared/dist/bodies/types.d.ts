 ...
 */
export declare enum SpectralClass {
    O = "O",// Blue, > 30,000 K
 ...
 */
export declare const DEFAULT_EARTH_ATMOSPHERE: AtmosphereProperties;
/**
 * Default terrain for rocky planets
 */
export declare const DEFAULT_ROCKY_TERRAIN: TerrainProperties;
