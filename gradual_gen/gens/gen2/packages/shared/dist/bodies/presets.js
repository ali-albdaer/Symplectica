 ...
 */
import { BodyType, BodyClass, SpectralClass, DEFAULT_EARTH_ATMOSPHERE, DEFAULT_ROCKY_TERRAIN } from './types.js';
import { Vector3 } from '../math/Vector3.js';
import { Quaternion } from '../math/Quaternion.js';
import { AU, SOLAR_MASS, EARTH_MASS, LUNAR_MASS, JUPITER_MASS, SOLAR_RADIUS, EARTH_RADIUS, LUNAR_RADIUS, JUPITER_RADIUS, SOLAR_LUMINOSITY, SECONDS_PER_DAY } from '../constants.js';
 ...
 */
export function createOrbitingBody(id, name, mass, radius, parentMass, orbitRadius, options = {}) {
 ...
 */
export function createSunEarthMoon() {
    const sun = {
        id: 'sun',
        name: 'Sun',
 ...
 */
export function createFullSolarSystem() {
    const sun = {
        id: 'sun',
        name: 'Sun',
        type: BodyType.MASSIVE,
 ...
 */
export function createAlphaCentauri() {
 ...
 */
export function createPSRB1620() {
 ...
 * Get preset by name
 */
export function getPresetWorld(name) {
 ...
 */
export function listPresetWorlds() {
    return [
