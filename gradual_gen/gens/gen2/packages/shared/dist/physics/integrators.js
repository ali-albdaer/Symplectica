...
export class VelocityVerletIntegrator {
    ...
    prevAccelerations = new Map();
    step(body, dt, time, getAcceleration) {
 ...
 */
export class AdaptiveRK45Integrator {
    ...
    static c = [0, 1 / 5, 3 / 10, 4 / 5, 8 / 9, 1, 1];
    static a = [
        [],
        [1 / 5],
        [3 / 40, 9 / 40],
    ...
    static b5 = [35 / 384, 0, 500 / 1113, 125 / 192, -2187 / 6784, 11 / 84, 0];
    static b4 = [5179 / 57600, 0, 7571 / 16695, 393 / 640, -92097 / 339200, 187 / 2100, 1 / 40];
    constructor(tolerance = 1e-10, minDt = 1e-6, maxDt = 3600) {
    ...
    adaptiveStep(body, dt, time, getAcceleration) {
        const x0 = body.position.clone();
        const v0 = body.velocity.clone();
        // Compute k values
        const k = [];
 ...
 */
export class GaussRadauIntegrator {
    name = 'Gauss-Radau (IAS15)';
    order = 15;
    isSymplectic = false;
    _tolerance;
    _minDt;
    ...
    constructor(tolerance = 1e-12, minDt = 1e-9) {
 ...
 */
export function createIntegrator(name) {
